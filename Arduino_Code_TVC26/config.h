...
constexpr int PITCH_MIN = 64;   
constexpr int PITCH_MAX = 116;   
constexpr int YAW_CENTER = 98;
constexpr int YAW_MIN = 90;     //figure out
constexpr int YAW_MAX = 106;     //figure out
...
constexpr float LAUNCH_ACCEL_THRESH = 14.71;    //2.5g
